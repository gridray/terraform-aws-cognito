...
output "arn" {
  ...
  value       = module.aws_cognito_user_pool_complete_example.arn
}
...
output "creation_date" {
  ...
  value       = module.aws_cognito_user_pool_complete_example.creation_date
}

output "last_modified_date" {
  description = "The date the user pool was last modified"
  value       = module.aws_cognito_user_pool_complete_example.last_modified_date
}
...
output "domain_aws_account_id" {
  ...
  value       = module.aws_cognito_user_pool_complete_example.domain_aws_account_id
}

output "domain_cloudfront_distribution_arn" {
  description = "The ARN of the CloudFront distribution"
  value       = module.aws_cognito_user_pool_complete_example.domain_cloudfront_distribution_arn
}

output "domain_s3_bucket" {
  description = "The S3 bucket where the static files for this domain are stored"
  value       = module.aws_cognito_user_pool_complete_example.domain_s3_bucket
}

output "domain_app_version" {
  description = "The app version"
  value       = module.aws_cognito_user_pool_complete_example.domain_app_version
}
...
output "client_ids_map" {
  ...
  value       = module.aws_cognito_user_pool_complete_example.client_ids_map
}

output "client_secrets_map" {
  description = "The client name to ids map"
  value       = module.aws_cognito_user_pool_complete_example.client_secrets_map
  sensitive   = true
}
...
output "resource_servers_scope_identifiers" {
  ...
  value       = module.aws_cognito_user_pool_complete_example.resource_servers_scope_identifiers
}